...
require_once( get_template_directory(). '/includes/remove-menus.php');
require_once( get_template_directory(). '/includes/custom_excerpt.php');
...
function bootstrapwp_widgets_init() {
    ...
    'name' => 'Introducao',
    'id'   => 'intro',
    'description'   => 'Textbox de Como Chegar',
  ...
  register_sidebar(array(
    'name' => 'Home 1',
    'id'   => 'home-1',
    'description'   => 'Textbox de Atividadades',
    'before_widget' => '<div id="%1$s" class="widget %2$s">',
    'after_widget'  => '</div>',
    'before_title'  => '<h2>',
    'after_title'   => '</h2>'
    ...
    'name' => 'Home 2',
    'id'   => 'home-2',
    'description'   => 'Textbox de Agendamento',
    'before_widget' => '<div id="%1$s" class="widget %2$s">',
    'after_widget'  => '</div>',
    'before_title'  => '<h2>',
    'after_title'   => '</h2>'
    ...
    'name' => 'Home 3',
    'id'   => 'home-3',
    'description'   => 'Textbox de Contato',
    'before_widget' => '<div id="%1$s" class="widget %2$s">',
    'after_widget'  => '</div>',
    'before_title'  => '<h2>',
    'after_title'   => '</h2>'
...
if ( function_exists( 'add_theme_support' ) ) {
  ...
  set_post_thumbnail_size( 300, 180, true ); // 160 pixels wide by 120 pixels high
}

if ( function_exists( 'add_image_size' ) ) {
  add_image_size( 'bootstrap-large', 300 , 382, true ); // 360 pixels wide by 268 pixels high
}
/*
| -------------------------------------------------------------------
 ...
 function bootstrapwp_breadcrumbs() {
  ...
  if ( !is_home() && !is_front_page() || is_paged() ) {
    ...
    if ( get_query_var('paged') ) {
      ...
      echo $before . $delimiter . __('Página', 'bootstrapwp') . ' ' . get_query_var('paged') . $after;
      if ( is_category() || is_day() || is_month() || is_year() || is_search() || is_tag() || is_author() ) echo ')';
    }
